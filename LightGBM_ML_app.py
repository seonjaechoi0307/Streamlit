...
def ML_LightGBM_app_Layout():
    ...
    with st.expander("Light GBM ML Section", expanded=True):
        ...
        with col1 :
            ...
            Sell_Price_option = st.number_input("평균적인 매매 가격을 입력하세요. (단위 : 만원)", key='LightGBM_Sell_Price_APT', step=1)
...
# 예측 결과를 계산하고 표시하는 함수
def calculate_dict_result(data_point, File_Name):
            ...
            with col1 :
                ...
                with col2 :
                    if (address != ""):
                        ...
                        # 딕셔너리값 기준으로 결과 나타내기
                        calculate_dict_result(data_point, File_Name)
